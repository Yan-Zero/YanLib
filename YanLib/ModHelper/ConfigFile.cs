...
// From BepInEx https://github.com/BepInEx/BepInEx/blob/e473f08e0a85fffd818f310c783458037a079ded/BepInEx.Core/Configuration/ConfigFile.cs
...
namespace YanLib.ModHelper
{
    ...
    {
        private readonly ModHelper _ownerMetadata;

        /// <inheritdoc cref="ConfigFile(string, bool, ModHelper)" />
        ...
        public ConfigFile(string configPath, bool saveOnInit, ModHelper ownerMetadata)
        {
        ...
        ///     System Config
        /// </summary>
        public static ConfigFile CoreConfig { get; } = new ConfigFile(Path.Combine(Game.GetArchiveDirPath(), "CoreSetting.ini"), true);
        ...
        internal void OnSettingChanged(object sender, ConfigEntryBase changedEntryBase)
        {
            ...
            foreach (EventHandler<SettingChangedEventArgs> callback in settingChanged.GetInvocationList())
                ...
                {
                    UnityEngine.Debug.unityLogger.Log(UnityEngine.LogType.Error, e);
                }
        }
